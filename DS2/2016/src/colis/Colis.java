...
public class Colis{
    ...
    /**
     * fournit le montant des frais d'expédition de ce colis, à partir du total
     * des frais d'expédition de chacun des aritcles du colis 
     * @return le montant des frais d'expédition de ce colis
     */
    ...
    /** ajoute un article à ce colis tant qu'il n'a pas été expédié, sinon une
     * exception est déclenchée
     * @param article l'article ajouté
     * @throws ColisExpedieException si le colis a déjà été expédié
     */
